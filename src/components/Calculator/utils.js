export const hasExceededPrecisionDigits = number => /\.\d{6,}/.test(number.toString() || number);
...
export const calculate = (operation, [firstValue, secondValue]) => {
    ...
    if (firstValue && typeof firstValue === 'number' && secondValue && typeof secondValue === 'number') {
